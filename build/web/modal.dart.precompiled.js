...
["ModalP", "modal_p.dart", , R, {
  "^": "",
  inputText: function(ATexto, ATitulo) {
    var t1, pResult, mc, m1, iw, ih, x, y, divItemTitle, t2, divItemContainer, t3, inpTexto, divButtonContainer, btnAceptar, t4, btnCancelar;
    t1 = P.String;
    pResult = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(t1)), [t1]);
    mc = document.createElement("div", null);
    mc.id = "modalItemList";
    ...
    J.set$height$x(mc.style, "100%");
    J.set$position$x(mc.style, "fixed");
    J.set$margin$x(mc.style, "0px");
    J.set$top$x(mc.style, "0px");
    J.set$left$x(mc.style, "0");
    J.set$top$x(mc.style, "0");
    J.set$border$x(mc.style, "none");
    J.set$display$x(mc.style, "block");
    m1 = document.createElement("div", null);
    J.set$width$x(m1.style, "400px");
    J.set$height$x(m1.style, "200px");
    J.set$position$x(m1.style, "fixed");
    ...
    if (typeof iw !== "number")
      return iw.$div();
    x = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(iw / 2 - 200));
    if (typeof ih !== "number")
      return ih.$div();
    y = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(ih / 2 - 250));
    J.set$top$x(m1.style, C.JSInt_methods.toString$0(y) + "px");
    J.set$left$x(m1.style, C.JSInt_methods.toString$0(x) + "px");
    t1 = J.getInterceptor$x(mc);
    t1.get$children(mc).add$1(0, m1);
    J.set$padding$x(m1.style, "0px");
    divItemTitle = document.createElement("div", null);
    t2 = J.getInterceptor$x(divItemTitle);
    t2.get$children(divItemTitle).add$1(0, W.Element_Element$html("<h3>" + ATitulo + "</h3>", null, null));
    J.set$textAlign$x(divItemTitle.style, "center");
    J.set$backgroundColor$x(divItemTitle.style, "rgb(240, 240, 240)");
    J.set$borderBottomStyle$x(divItemTitle.style, "solid");
    J.set$borderColor$x(divItemTitle.style, "black");
    J.set$borderWidth$x(divItemTitle.style, "1px");
    J.set$marginTop$x(J.get$style$x(t2.get$children(divItemTitle).$index(0, 0)), "0px");
    J.set$marginBottom$x(J.get$style$x(t2.get$children(divItemTitle).$index(0, 0)), "0px");
    J.set$height$x(divItemTitle.style, "25px !important");
    J.set$paddingTop$x(divItemTitle.style, "5px !important");
    t2 = J.getInterceptor$x(m1);
    t2.get$children(m1).add$1(0, divItemTitle);
    divItemContainer = document.createElement("div", null);
    J.set$height$x(divItemContainer.style, "100px");
    J.set$overflowY$x(divItemContainer.style, "auto");
    t2.get$children(m1).add$1(0, divItemContainer);
    t1.set$tabIndex(mc, 0);
    mc.focus();
    t3 = new R.inputText_fComplete(pResult);
    t1 = t1.get$onKeyDown(mc);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.inputText_closure(t3)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    inpTexto = W.InputElement_InputElement(null);
    J.set$paddingTop$x(inpTexto.style, "13px");
    inpTexto.id = "inpTexto";
    J.set$marginTop$x(inpTexto.style, "30px");
    J.set$marginLeft$x(inpTexto.style, "50px");
    J.set$height$x(inpTexto.style, "15px");
    J.set$padding$x(inpTexto.style, "5px");
    J.set$width$x(inpTexto.style, "300px");
    t1 = J.getInterceptor$x(inpTexto);
    t1.set$value(inpTexto, ATexto);
    J.get$children$x(divItemContainer).add$1(0, inpTexto);
    document.body.appendChild(mc);
    divButtonContainer = document.createElement("div", null);
    J.set$borderTopStyle$x(divButtonContainer.style, "solid");
    J.set$borderColor$x(divButtonContainer.style, "black");
    J.set$borderWidth$x(divButtonContainer.style, "1px");
    btnAceptar = W.Element_Element$html("<button>Aceptar</button", null, null);
    t4 = J.getInterceptor$x(btnAceptar);
    J.set$$float$x(t4.get$style(btnAceptar), "right");
    J.set$marginTop$x(btnAceptar.style, "20px");
    J.set$marginRight$x(btnAceptar.style, "5px");
    t4 = t4.get$onClick(btnAceptar);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new R.inputText_closure0(t3, inpTexto)), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
    btnCancelar = W.Element_Element$html("<button>Cancelar</button", null, null);
    t4 = J.getInterceptor$x(btnCancelar);
    J.set$$float$x(t4.get$style(btnCancelar), "right");
    J.set$marginTop$x(btnCancelar.style, "20px");
    J.set$marginRight$x(btnCancelar.style, "5px");
    t4 = t4.get$onClick(btnCancelar);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new R.inputText_closure1(t3)), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
    t4 = J.getInterceptor$x(divButtonContainer);
    t4.get$children(divButtonContainer).add$1(0, btnAceptar);
    t4.get$children(divButtonContainer).add$1(0, btnCancelar);
    t2.get$children(m1).add$1(0, divButtonContainer);
    inpTexto.focus();
    t1.select$0(inpTexto);
    return pResult.future;
  },
  inputText_fComplete: {
    "^": "Closure:8;pResult_0",
    call$1: function(AResult) {
      this.pResult_0.complete$1(0, AResult);
      J.remove$0$ax(document.querySelector("#modalItemList"));
    },
    $isFunction: true
  },
  inputText_closure: {
    "^": "Closure:9;fComplete_1",
    call$1: function($event) {
      var code;
      if (document.querySelector("#modalItemList") == null)
        return false;
      code = J.get$which$x($event);
      if (code === 13) {
        this.fComplete_1.call$1(J.get$value$x(document.querySelector("#inpTexto")));
        $event.preventDefault();
        $event.stopPropagation();
      }
      if (code === 27) {
        this.fComplete_1.call$1(null);
        $event.preventDefault();
        $event.stopPropagation();
      }
    },
  ...
  inputText_closure0: {
    "^": "Closure:10;fComplete_2,inpTexto_3",
    call$1: function(_) {
      this.fComplete_2.call$1(J.get$value$x(this.inpTexto_3));
    },
    $isFunction: true
  },
  inputText_closure1: {
    "^": "Closure:10;fComplete_4",
    call$1: function(_) {
      this.fComplete_4.call$1(null);
    },
    $isFunction: true
  }
}],
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  CssStyleDeclarationBase: {
    ...
    set$borderBottomStyle: function(receiver, value) {
      this.setProperty$3(receiver, "border-bottom-style", value, "");
    },
    ...
    set$borderTopStyle: function(receiver, value) {
      this.setProperty$3(receiver, "border-top-style", value, "");
    },
...
["", "modal.dart", , D, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(D.btnClick$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#btnCerrar"));
  ...
  btnClick: [function($event) {
    var pData, pData2, pLista, i, pDataX;
    pData = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.String);
    pData.$indexSet(0, "id", "1");
    pData.$indexSet(0, "nombre", "adri\u00e1n");
    pData2 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.String);
    pData2.$indexSet(0, "id", "2");
    pData2.$indexSet(0, "nombre", "otro");
    pLista = H.setRuntimeTypeInfo([], [[P.Map, P.String, P.String]]);
    pLista.push(pData);
    pLista.push(pData2);
    for (i = 3; i <= 100; ++i) {
      pDataX = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.String);
      pDataX.$indexSet(0, "id", C.JSInt_methods.toString$0(i));
      pDataX.$indexSet(0, "nombre", C.JSInt_methods.toString$0(i));
      pLista.push(pDataX);
    }
    R.inputText("Demo", "T\u00edtulo Demo").then$1(new D.btnClick_closure());
  }, "call$1", "btnClick$closure", 2, 0, 7],
  main_closure: {
    "^": "Closure:10;",
    call$1: function(_) {
      J.set$display$x(document.querySelector("#mc").style, "none");
    },
    $isFunction: true
  },
  btnClick_closure: {
...
J.set$borderBottomStyle$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$borderBottomStyle(receiver, value);
};
...
J.set$borderTopStyle$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$borderTopStyle(receiver, value);
};
...
function dart_precompiled($collectedClasses) {
  ...
  function inputText_fComplete(pResult_0) {
    this.pResult_0 = pResult_0;
  }
  inputText_fComplete.builtin$cls = "inputText_fComplete";
  if (!"name" in inputText_fComplete)
    inputText_fComplete.name = "inputText_fComplete";
  $desc = $collectedClasses.inputText_fComplete;
  if ($desc instanceof Array)
    $desc = $desc[1];
  inputText_fComplete.prototype = $desc;
  function inputText_closure(fComplete_1) {
    this.fComplete_1 = fComplete_1;
  }
  inputText_closure.builtin$cls = "inputText_closure";
  if (!"name" in inputText_closure)
    inputText_closure.name = "inputText_closure";
  $desc = $collectedClasses.inputText_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  inputText_closure.prototype = $desc;
  function inputText_closure0(fComplete_2, inpTexto_3) {
    this.fComplete_2 = fComplete_2;
    this.inpTexto_3 = inpTexto_3;
  }
  inputText_closure0.builtin$cls = "inputText_closure0";
  if (!"name" in inputText_closure0)
    inputText_closure0.name = "inputText_closure0";
  $desc = $collectedClasses.inputText_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  inputText_closure0.prototype = $desc;
  function inputText_closure1(fComplete_4) {
    this.fComplete_4 = fComplete_4;
  }
  inputText_closure1.builtin$cls = "inputText_closure1";
  if (!"name" in inputText_closure1)
    inputText_closure1.name = "inputText_closure1";
  $desc = $collectedClasses.inputText_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  inputText_closure1.prototype = $desc;
